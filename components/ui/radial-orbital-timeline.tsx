...
export default function RadialOrbitalTimeline({
  ...
  // Оптимизированная функция расчета позиции с мемоизацией
  ...
  }, [rotationAngle, centerOffset.x, centerOffset.y]);
  ...
  // Мемоизированная функция стилей для предотвращения повторных вычислений
  ...
  return (
    <div
      className="w-full h-screen flex flex-col items-center justify-center bg-gradient-to-br from-black via-[#079669] to-black overflow-hidden"
      ref={containerRef}
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-emerald-500 via-[#079669] to-teal-600 animate-pulse flex items-center justify-center z-10">
          ...
          {timelineData.map((item, index) => {
            ...
            // Выбор иконки на основе строкового имени
            let IconComponent;
            switch(item.icon) {
              case 'calendar':
                    ...
                    <CardContent className="text-xs text-white/80">
                      ...
                      <div className="mt-4 pt-3 border-t border-white/10">
                        ...
                        <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
                          <div
                            className="h-full bg-gradient-to-r from-emerald-500 to-[#079669]"
